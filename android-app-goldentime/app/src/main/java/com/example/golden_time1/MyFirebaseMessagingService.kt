...
class MyFirebaseMessagingService: FirebaseMessagingService() {
    ...
    private fun sendNotification(remoteMessage: RemoteMessage) {
        ...
        val pendingIntent = PendingIntent.getActivity(
            ...
            uniId,
            intent,
            PendingIntent.FLAG_ONE_SHOT or PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE // Adding FLAG_IMMUTABLE
        )
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            ...
            .setContentTitle(remoteMessage.data["title"].toString()) // Title
            .setContentText(remoteMessage.data["body"].toString())   // Body
            .setAutoCancel(true)
